...
const ItemsContainer = () => {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-6 sm:px-8 px-5 py-16 justify-around  align-middle">
       <div className="pe-10 flex flex-col gap-3 justify-center align-middle">
          <h1 className="mb-1 font-semibold">Free to give your suggestion</h1>
          <div className="flex flex-col gap-3">
           ...
           sm:w-72 !w-full sm:mr-5 mr-1 lg:mb-0 mb-4 py-2.5 rounded px-2 focus:ring-blue-500 focus:border-blue-500"
            ...
            <textarea
              id="message"
              rows="3"
              class="block p-2.5 w-full text-sm text-black-900 bg-white-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 bg-slate-600 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 "
